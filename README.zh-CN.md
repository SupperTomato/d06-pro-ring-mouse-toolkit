...
每个 SDK 部分、命令和事件能做什么，见通俗说明：[FUNCTIONS.zh-CN.md](FUNCTIONS.zh-CN.md)。

SDK 性能优化建议见：[PERFORMANCE.zh-CN.md](PERFORMANCE.zh-CN.md)。
...
| `FUNCTIONS.md` / `FUNCTIONS.zh-CN.md` | 工具包功能和特性的通俗说明 |
